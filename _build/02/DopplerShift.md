...
redirect_from:
  - "/02/dopplershift"
interact_link: content/02/DopplerShift.ipynb
kernel_name: python3
has_widgets: false
title: 'Dopple Shift'
prev_page:
...
{:.output_data_text}
```
HBox(children=(Figure(axes=[Axis(grid_lines='none', label='Wavelength (nm)', num_ticks=12, scale=LinearScale(m…
```
...
{:.output_data_text}
```
HBox(children=(VBox(children=(Figure(axes=[Axis(grid_lines='none', label='Wavelength (nm)', num_ticks=12, scal…
```
